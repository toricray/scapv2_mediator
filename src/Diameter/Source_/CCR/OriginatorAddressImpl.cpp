...
COriginatorAddressImpl::COriginatorAddressImpl(IAVP* _pAVP) :
...
COriginatorAddressImpl::COriginatorAddressImpl(const unsigned char* _Data, unsigned int _Size) :
	m_AddressType((AddressType)-1),
	m_AddressData(""),
	m_pAVP(NULL)
{
...
COriginatorAddressImpl::~COriginatorAddressImpl()
{
}

AddressType COriginatorAddressImpl::GetAddressType()
{
	return m_AddressType;
}

const char* COriginatorAddressImpl::GetAddressData()
{
	return m_AddressData.c_str();
}

bool COriginatorAddressImpl::SetAddressType(AddressType _AddressType)
{
...
bool COriginatorAddressImpl::SetAddressData(const char* _AddressData)
{
